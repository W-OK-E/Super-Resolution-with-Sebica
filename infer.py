    ...
    def predict_and_display(self, start_idx=0):
        ...
        with torch.no_grad():
            for idx, (x, lbl) in enumerate(tqdm(self.test_dataloader, desc=f'[Test]', smoothing=1.0)):
                ...
                org_img = Image.fromarray(tensor2img(org_x))
                sr_img = Image.fromarray(tensor2img(y))
                out_path = '/home/summer/Super-Resolution/Sebica/out_images/' + str(idx) + ".jpeg"
                
                width1, height1 = org_img.size
                width2, height2 = sr_img.size

                # Create a new image with combined width and maximum height
                combined_width = width1 + width2 + 10
                combined_height = max(height1, height2)
                combined_image = Image.new("RGB", (combined_width, combined_height), color=(255, 255, 255))

                # Paste the images into the new image
                combined_image.paste(org_img, (0, combined_height//2))  # Paste img1 at (0, 0)
                combined_image.paste(sr_img, (width1 + 10, 0))  # Paste img2 next to img1
...
if __name__ == '__main__':
    ...
    img_path =os.path.expanduser("/home/summer/Super-Resolution/Sebica/dataset/val/LR")
    lbl_path=os.path.expanduser("/home/summer/Super-Resolution/Sebica/dataset/val/HR")
    ...
    if arch == 'standard':
        ...
        ckpt ='/home/summer/Super-Resolution/Sebica/logs/ckpts/RTSR_N16_epochs50_psnr0.0000_ssim0.0000.pth'
